...
<div class="tldr">
  ...
  <div class="item"><b>③ 隔夜美股只是"放大器"，不是主因</b><p>大跌日前夜费半≤-2% 的占比仅 24.3%；条件概率看，隔夜费半≤-2% 时当日大跌概率 27.0%（基准 17.2%，1.6 倍）——<b>约四分之三的大跌日并非美股引起</b>，必须盯国内资金面与政策事件。</p></div>
...
<div class="card">
  ...
  <table>
    ...
    <tbody>
      <tr><td><b>A1 隔夜费半(SOXX)</b></td><td>≤-2%：+2；(-2%,-1%]：+1</td><td class="mono">0-2</td><td class="dim">SOXX≤-2%→当日大跌P=27%（1.6×基准）</td></tr>
      <tr><td><b>A2 隔夜纳指(QQQ)</b></td><td>≤-2%：+1（与A1不叠加取高）</td><td class="mono">0-1</td><td class="dim">QQQ≤-2%→31.8%（1.85×基准）</td></tr>
